...
export default function Impact(){
    ...
    return(
        <section>
            ...
            <h1 className="text-42 md:text-56 font-['paytone-one'] font-bold text-center mt-10 leading-[59px]">Our Areas of <span className='text-pry'>Impact</span></h1> 
            <br /> 
            <p className="text-para2 text-18 md:w-747 mx-auto text-center">
            ...
            <article className="md:w-[820px] mt-[94px] md:mt-0 mx-auto flex justify-between flex-col md:flex-row">
            ...
            <article className="flex justify-center flex-col items-center mt-5">
                    <div className="text-center flex flex-col justify-center items-center">
                        <div className="relative  w-[137px] h-[137px] md:w-[146px] md:h-[146px]">
