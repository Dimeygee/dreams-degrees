...
export default function MeetTheTeam(){
    ...
    return(
        <div className="mt-[151px] mb-[149px]">
            <h1 className="text-56 text-center  font-bold font-['Paytone One'] font-paytone">Meet the <span className="text-pry">Team</span></h1>
            <div className="container mx-auto  py-10 font-fellix">
                <div className="flex justify-evenly">
                    <div className='inline-block text-center'>
                        <div className="w-125 h-125 relative mx-auto">
                ...
                <div className="flex justify-evenly mt-[56px] w-[924px] mx-auto">
                <div className='inline-block  text-center '>
                        <div className="w-125 h-125 relative mx-auto">
