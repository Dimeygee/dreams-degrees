        ...
        <div >
            <article >
                ...
                <div className="w-[230px] mt-[24px]">
                    <BButton width="100%" backgroundColor="#D68676" padding="15px 0" color="white" fontSize="16px" involedAs="intern">
            ...
            <article className="mt-[56px]">
                ...
                Intersted?</p>
                <div className="w-[230px] mt-[24px]">
                    <BButton width="100%" backgroundColor="#D68676" padding="15px 0" color="white" fontSize="16px" involedAs="patner/sponsor">
