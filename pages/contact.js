...
export default function Contact() {
    ...
    return(
        <div className="contact_bg  min-h-1/5 pt-[80px]">
            <Head>
            <title>Dreams&Degrees</title>
            <meta name="description" content="Generated by create next app" />
            <link rel="preload" as="image" href="/images/lbg2.png" />
            ...
            <div className='contact_form mb-[146px]'>
                <form>
                    <label className='mb-[30px] block mx-auto'>
                        <input type='text'  placeholder='Your name' className='p-[15px]  bg-fm rounded-[28px]' />
                    </label>
                    <label className='mb-[30px] block  mx-auto '>
                        <input type='text'  placeholder='Your email' className='p-[15px] bg-fm rounded-[28px]' />
                    </label>
                    <label className='mb-[30px] block mx-auto'>
                        <input type='text'  placeholder='Your phone number' className='p-[15px] bg-fm rounded-[28px]' />
                    </label>
                    <label className='mb-[30px] block mx-auto'>
                        <textarea type='text'  placeholder='Your message' className='textarea h-[240px] p-[15px] bg-fm rounded-[28px]' ></textarea>
                    </label>
                    <button className="contact_btn rounded-[28px] bg-pry text-[#ffff] text-16 font-[700]  py-[15px]">Send a Message</button>
                </form>
            </div>
            <div className="w-[1110px]  mx-auto px-[20px] flex justify-between">
