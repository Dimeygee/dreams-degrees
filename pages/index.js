...
export default function Home() {
  return (
    <div>
      ...
      <section className="text-center pt-[160px] grow flex flex-col justify-between">
          <motion.h1 
          ...
          initial="hidden"
          animate="visible"
          className='header_btn_div mt-[40px] px-[20px] md:px-0 font-fellix flex justify-center'>
            <BButton backgroundColor="#D68676" padding="15px 59px" color="white">
                <span className="text-16 font-[600]">Get started</span>                  
              </BButton>
              <span className="md:ml-5">
                <BButton backgroundColor="transparent" padding="15px 59px" color="black" border="2px solid black">
